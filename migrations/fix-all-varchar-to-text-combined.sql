-- Combined migration to fix all VARCHAR to TEXT type mismatches
-- This fixes all RPC functions that have VARCHAR in their return types
-- PostgreSQL table columns are TEXT, so function return types must match

-- =============================================================================
-- 1. get_user_collections_with_stats
-- =============================================================================
...
-- =============================================================================
-- 2. get_friends_public_collections
-- =============================================================================
...
BEGIN
  ...
  GROUP BY c.id, c.title, c.description, c.is_public, c.created_at, c.updated_at, c.user_id, u.username, u.profile_image, c.color
  ORDER BY c.updated_at DESC;
END;
$$;

-- =============================================================================
-- 3. get_discover_collections
-- =============================================================================
...
-- =============================================================================
-- 4. get_public_collections_with_details
-- =============================================================================
...
BEGIN
  ...
  WHERE c.is_public = true
  GROUP BY c.id, c.title, c.description, c.created_at, c.user_id, u.username, u.profile_image, c.color
  ORDER BY c.created_at DESC;
END;
$$;

-- =============================================================================
-- 5. get_collection_with_pin_count
-- =============================================================================
